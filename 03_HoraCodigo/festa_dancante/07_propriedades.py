...
# Inicializa a tartaruga dançarina
apoio_um = turtle.Turtle()
apoio_um.shape('turtle')
apoio_um.setheading(90)
apoio_um.setx(200)
apoio_um.shapesize(3)

# Inicializa a dançarina de apoio dois
apoio_dois = turtle.Turtle()
apoio_dois.shape('turtle')
apoio_dois.shapesize(5)
apoio_dois.setheading(90)
apoio_dois.setx(-200)
apoio_dois.shapesize(3)
...
def mexe_direita():
    ...
    apoio_um.setheading(95)
    apoio_dois.setheading(95)
    muda_palco()
    turtle.ontimer(mexe_esquerda, 200)
    #turtle.ontimer(muda_palco, 200)    


def mexe_esquerda():
    dançarina.setheading(85)
    apoio_um.setheading(85)
    apoio_dois.setheading(85)
    muda_palco()
...
def move_direita():
    dançarina.setx(10)
    apoio.setx(10)
    turtle.ontimer(move_esquerda, 1000)    


def move_esquerda():
    dançarina.setx(-10)
    apoio.setx(-10)
    turtle.ontimer(move_direita, 1000)
